...
\SetContentTitle{\MakeUppercase{\epilogueTitle}}
...
\SetContentTitle{\MakeUppercase{\titlebibliography}}
\protect\bibliographystyle{./packages/ieeetr-redux} % default bibliography style
\pagestyle{phdfancyspecialempty}\bibliography{./utils/report-bib}
\protect\thispagestyle{phdfancyempty}
...
\ifmultibib
	\SetContentTitle{\MakeUppercase{\listofpublicationsname}}
