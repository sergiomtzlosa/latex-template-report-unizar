...
\SetContentTitle{\MakeUppercase{\contentsname}}
...
\SetContentTitle{\MakeUppercase{\listequationsname}}
\protect\thispagestyle{phdfancyempty}
\phantomsection\addcontentsline{toc}{chapter}{\listequationsname}
\protect\pagestyle{phdfancyspecialempty}\listofmyequations
\clearpage

% show glossary items
\SetContentTitle{\MakeUppercase{\glossaryname}}
\protect\thispagestyle{phdfancyempty}
\phantomsection\addcontentsline{toc}{chapter}{\glossaryname}
\protect\pagestyle{phdfancyspecialempty}\printglossaries
\clearpage
...
%\protect\thispagestyle{empty}
\pagestyle{phdplainfancy}\bibliography{./utils/report-bib}
\protect\thispagestyle{phdplainfancy}
...
\ifmultibib
	...
	\protect\pagestyle{phdplainfancy}
	\nocitepublications{*}
...
\phantomsection\addcontentsline{toc}{chapter}{Epilogue}
\protect\pagestyle{phdplainfancy}\input{utils/epilogue}
\protect\thispagestyle{phdplainfancy}
\clearpage
