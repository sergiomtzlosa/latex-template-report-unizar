...
\usepackage{chapterbib} % bibliography in chapters
\usepackage[sectionbib,super,square]{natbib} % bibliography in chapters
...
\iffilepublications
	...
	\usepackage{multibib} % multiple biblipography
