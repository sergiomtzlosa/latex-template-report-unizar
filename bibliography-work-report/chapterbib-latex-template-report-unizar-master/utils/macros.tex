	...
	\begin{figure}[H]
		...
		\ifthenelse{\equal{#5}{}}{
			\ifthenelse{\equal{#7}{}}{
				...
				\captionsetup[subfigure]{belowskip=\spaceBelowCaptionEquations, labelformat=empty, justification=raggedright, singlelinecheck=true}
			}{}
		}{}
...
\def\spaceBelowCaptionEquations{-4pt}
