...
\par
\noindent
\textbf{\textsf{\THEUNIVERSITY} | \textsf{\bold{Science faculty}}}
\vfill
\noindent
...
\vskip 0.01cm
\noindent
\textsf{\bold{August 2021 - October 2021}}
%\textsf{\bold{\coverdate\today}}
\hfill
\begin{tikzpicture}[overlay, remember picture]

\node[align=center,opacity=0.45] at ($(current page.south)+(7.7,0.5)$) {
	% LOGOS: https://unizar.es/identidad-corporativa/logos
	{\includegraphics[scale=1.5]{logo-simple-white}}\\[1cm]
