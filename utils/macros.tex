...
\newcommandtwoopt{\sticker}[3][][true]{%
	...
	\ifx\printableimages\trueValue
		...
		\ifx\valueTmp\itemWidth
			\todo[inline, shadow=0.8, bordercolor=black, color=white]{#3}
		\else
			\todo[inline, shadow=0.8, bordercolor=black, color=white]{\centerline{#3}}
		\fi
		
	\else
	
		\ifx\valueTmp\itemWidth
			\todo[inline, shadow=0.8, bordercolor=black, color=amber!50]{#3}
		\else
			\todo[inline, shadow=0.8,bordercolor=black, color=amber!50]{\centerline{#3}}
		\fi
