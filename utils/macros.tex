	...
	\begin{equ}[H]
		...
		\begin{changemargin}{#1}{#2}
			\begin{eqfigure}[H]
				...
				\centercaption{#5}
				\label{#4}
				\myequations{#5} % this is for equations listing
			\end{eqfigure}
		\end{changemargin}	
		\vspace{-1.5cm}
	\end{equ}
...
\newcommand{\listequationtitle}{\listequationsname\\\vspace{-0.5cm}\rule{\linewidth}{1pt}\vspace{1.5cm}}
\newlistof{myequations}{equ}{\listequationtitle}
\newcommand{\myequations}[1]{%
	\addcontentsline{equ}{myequations}{\protect\numberline{\theeqfigure}#1}\par}
\addtolength{\cftmyequationsnumwidth}{13pt}
...
\newcommand{\textposition}[4]{ % Block width, X, Y, text
	
	\begin{textblock*}{#1}(#2,#3) % {block width} (coords) 
		\protect{~\hfill\textbf{#4}\par\protect\thispagestyle{phdfancyempty}}
	\end{textblock*}
}
