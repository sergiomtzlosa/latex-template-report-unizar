\begin{tikzpicture}[overlay,remember picture]
	...
	\node[opacity=0.06,left color=white] (image) at ($(current page.south)+(6.50,4.0)$) {{\includegraphics[scale=11.0]{unizar-logo-black}}};
	
	%\node[opacity=0.1,left color=white] (image) at ($(current page.south)+(6.50,4.0)$) {{\includegraphics[scale=11.0]{unizar-logo-blue}}};
	...
	\node[align=center] at ($(current page.center)+(0,-5)$) {
		...
		{\includegraphics[scale=1.8]{unizar-hq}}\\[1cm]
